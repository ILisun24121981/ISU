...
#define	DEFAULT_SM1_MOVING_SPEED                    7813//10 шага в сек - для расчета файл Speed - ограничение на ввод максимальной скорости  - максимальная скорость не может быть ниже 2 ш/сек
