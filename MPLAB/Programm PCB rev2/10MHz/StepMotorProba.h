...
#define	DEFAULT_MIN_SPEED                       0x9896//2шага в сек - для расчета файл Speed - ограничение на ввод максимальной скорости  - максимальная скорость не может быть ниже 2 ш/сек
