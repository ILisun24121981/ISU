...
void InitTimers(void){//функция инициализации таймеров
    ...
    T2CONbits.TSIDL = 1;
    T2CONbits.TGATE = 0;
    T2CONbits.TCKPS = 0b11; //k=256 (Fcy = 20MHz) => частота заполнения TMR2(Ftmr2) = Fcy/K = 78,125kHz => интервал заполнения TMR2 (Ttmr2)=1/Ftmr2 = 12.8us
    //PR2 = 7813;//количество интервалов (Ttmr2=12.8us) на один шаг => Tшага = PR2*Ttmr2 (RP2 =7812,5 => Tшага =0.1c) - изменение данного регистра - изменение скорости ШД - см. файл  Speed
    ...
    T4CONbits.TSIDL = 1;
    T4CONbits.TGATE = 0;
    T4CONbits.TCKPS = 0b11;         //k=256 (Fcy = 20MHz) => частота заполнения TMR2(Ftmr2) = Fcy/K = 78.125kHz => интервал заполнения TMR2 (Ttmr2)=1/Ftmr2 = 12.8us
    PR4 = DEFAULT_SM1_MOVING_SPEED; //PR2=7813//количество интервалов (Ttmr2=12.8us) в одной фазе шага(1шаг = 4фазы) => Tшага = PR2*Ttmr2*4 (RP2 =7812,5 => Tшага =0.1c) - изменение данного регистра - изменение скорости ШД - см. файл  Speed
    T4CONbits.TCS = 0;
    ClearFlagTimer4Int();
    DisTimer4Int();
    TMR4 = 0;
